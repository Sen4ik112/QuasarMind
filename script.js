...
{ id:1, name:'Футболки', category:'men-odiah-futbolky-ta-maiky-futbolky', gender:'men', price:0, images:['','',''], description:'', recommended:true, colorVariantId:71 },
  ...
  { id:142, name:'Гаманці та портмоне', category:'women-aksesuary-hamantsi-ta-portmone', gender:'women', price:0, images:['','',''], description:'', recommended:false, colorVariantId:143 },
  { id:143, name:'Гаманці та портмоне (інший колір)', category:'women-aksesuary-hamantsi-ta-portmone', gender:'women', price:0, images:['','',''], description:'', colorVariantId:142 },

  { id:134, name:'Зіп-худі', category:'men-odiah-kofty-ta-svetry-zip-khudi', gender:'men', price:0, images:['','',''], description:'', recommended:false, colorVariantId:135 },
  { id:135, name:'Зіп-худі (інший колір)', category:'men-odiah-kofty-ta-svetry-zip-khudi', gender:'men', price:0, images:['','',''], description:'', colorVariantId:134 },

  { id:136, name:'Худі', category:'women-odiah-kofty-ta-svetry-khudi', gender:'women', price:0, images:['','',''], description:'', recommended:false, colorVariantId:137 },
  { id:137, name:'Худі (інший колір)', category:'women-odiah-kofty-ta-svetry-khudi', gender:'women', price:0, images:['','',''], description:'', colorVariantId:136 },

  { id:138, name:'Світшоти', category:'women-odiah-kofty-ta-svetry-svitshoty', gender:'women', price:0, images:['','',''], description:'', recommended:false, colorVariantId:139 },
  { id:139, name:'Світшоти (інший колір)', category:'women-odiah-kofty-ta-svetry-svitshoty', gender:'women', price:0, images:['','',''], description:'', colorVariantId:138 },

  { id:140, name:'Зіп-худі', category:'women-odiah-kofty-ta-svetry-zip-khudi', gender:'women', price:0, images:['','',''], description:'', recommended:false, colorVariantId:141 },
  { id:141, name:'Зіп-худі (інший колір)', category:'women-odiah-kofty-ta-svetry-zip-khudi', gender:'women', price:0, images:['','',''], description:'', colorVariantId:140 },
];
...
const categoryBreadcrumbs = {
  ...
  'men-odiah-kofty-ta-svetry-zip-khudi': 'Чоловікам / Одяг / Кофти та светри / Зіп-худі',
  'women-odiah-kofty-ta-svetry-khudi': 'Жінкам / Одяг / Кофти та светри / Худі',
  'women-odiah-kofty-ta-svetry-svitshoty': 'Жінкам / Одяг / Кофти та светри / Світшоти',
  'women-odiah-kofty-ta-svetry-zip-khudi': 'Жінкам / Одяг / Кофти та светри / Зіп-худі',
};
const categoryTree = {
  "men": {
    "label": "Чоловікам",
